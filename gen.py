...
html{background:#0A0A0A;scrollbar-width:none;-ms-overflow-style:none;scroll-behavior:smooth;color-scheme:dark}
...
.page-label{font-size:11px;font-weight:600;color:#999;letter-spacing:.25em;text-transform:uppercase;margin-bottom:12px}
.page-title{font-size:clamp(40px,6vw,56px);font-weight:800;letter-spacing:-.04em;line-height:1;margin-bottom:16px;color:#fff}
.page-desc{font-size:17px;color:#a1a1a1;max-width:480px;line-height:1.55;font-weight:400}
.projects-grid{display:grid;grid-template-columns:repeat(auto-fill,minmax(300px,1fr));gap:20px;margin-top:40px}
.project-card{border:1px solid rgba(255,255,255,.1);border-radius:12px;padding:24px;text-decoration:none;color:#fff;transition:all .3s;display:flex;flex-direction:column;gap:12px;background:rgba(255,255,255,.02);position:relative;overflow:hidden}
.project-card:hover{border-color:rgba(255,255,255,.25);transform:translateY(-2px);background:rgba(255,255,255,.04)}
.project-card::before{content:"";position:absolute;top:0;left:-60%;width:50%;height:100%;background:linear-gradient(100deg,transparent,rgba(255,255,255,.07),transparent);transform:skewX(-15deg);transition:left .6s ease;pointer-events:none}
.project-card:hover::before{left:130%}
.project-card h3{font-size:18px;font-weight:700;letter-spacing:-.02em}
.project-card p{font-size:14px;color:#a1a1a1;line-height:1.5;flex:1}
.project-tags{display:flex;flex-wrap:wrap;gap:6px}
.project-tag{font-size:11px;font-weight:500;color:#888;padding:3px 10px;border:1px solid rgba(255,255,255,.12);border-radius:980px}
.project-hero{padding:120px 24px 40px;max-width:760px;margin:0 auto}
.project-hero h1{font-size:clamp(48px,8vw,72px);font-weight:800;letter-spacing:-.05em;line-height:1;margin-bottom:8px;color:#fff}
.project-hero .version{font-size:13px;font-weight:600;color:#888;letter-spacing:.05em;margin-bottom:12px}
.project-hero .sub{font-size:18px;color:#a1a1a1;line-height:1.5;max-width:560px}
.project-section{max-width:760px;margin:0 auto;padding:0 24px 48px}
.project-section h2{font-size:22px;font-weight:700;letter-spacing:-.03em;margin-bottom:16px;padding-top:16px;border-top:1px solid rgba(255,255,255,.08);color:#fff}
.project-section h3{font-size:16px;font-weight:700;margin-bottom:8px;margin-top:20px}
.project-section p{font-size:14px;color:#b5b5b5;line-height:1.65;margin-bottom:12px}
.project-section ul{list-style:none;padding:0;margin:0 0 12px}
.project-section li{font-size:14px;color:#b5b5b5;line-height:1.65;padding:3px 0;padding-left:16px;position:relative}
.project-section li::before{content:"·";position:absolute;left:0;font-weight:700;color:#888}
.pipeline{background:#141414;border:1px solid rgba(255,255,255,.08);border-radius:10px;padding:16px 20px;overflow-x:auto;font-family:'SF Mono',Menlo,Consolas,monospace;font-size:12px;line-height:1.7;color:#e5e5e5;white-space:pre-wrap;word-break:break-word;margin:8px 0 16px}
.code-block{background:#141414;border:1px solid rgba(255,255,255,.08);border-radius:10px;padding:16px 20px;overflow-x:auto;margin:8px 0 16px}
.code-block pre{margin:0;font-family:'SF Mono',Menlo,Consolas,monospace;font-size:13px;line-height:1.6;color:#e5e5e5}
.layout-grid{display:grid;grid-template-columns:120px 1fr;gap:4px 16px;font-size:13px;font-family:'SF Mono',Menlo,Consolas,monospace;line-height:1.7}
.layout-grid .dir{color:#fff;font-weight:600}
.layout-grid .desc{color:#999;font-family:'Inter',sans-serif;font-size:13px}
.cta-row{display:flex;gap:12px;margin-top:20px;flex-wrap:wrap}
.cta-btn{display:inline-flex;align-items:center;gap:8px;padding:10px 20px;border-radius:980px;font-size:14px;font-weight:600;text-decoration:none;transition:all .3s;border:1px solid rgba(255,255,255,.15);color:#fff;background:rgba(255,255,255,.06)}
.cta-btn:hover{background:rgba(255,255,255,.12);border-color:rgba(255,255,255,.25);transform:translateY(-2px)}
...
.footer-inner{max-width:980px;margin:0 auto;display:flex;align-items:center;justify-content:space-between;position:relative}
.footer-left{display:flex;align-items:center;gap:10px;font-size:12px;color:#888}
.footer-version{position:absolute;left:50%;transform:translateX(-50%);font-size:11px;color:#777;font-weight:600;letter-spacing:.05em;border:1px solid rgba(255,255,255,.15);border-radius:6px;padding:1px 7px}
.footer-links{display:flex;gap:20px}
.footer-links a{font-size:12px;color:#888;text-decoration:none;transition:color .3s;font-weight:500}
.footer-links a:hover{color:#fff}
.not-found{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;text-align:center}
.not-found h1{font-size:clamp(60px,10vw,120px);font-weight:800;letter-spacing:-.05em;color:#fff;margin-bottom:8px}
.not-found p{font-size:17px;color:#999;margin-bottom:24px}
.not-found a{font-size:14px;color:#fff;text-decoration:none;border-bottom:1px solid #fff;transition:opacity .3s}
.not-found a:hover{opacity:.5}
.home-center{display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;text-align:center;flex:1;padding:0 24px;position:relative}
.home-center::before{content:"";position:absolute;top:50%;left:50%;width:min(760px,100vw);aspect-ratio:1;transform:translate(-50%,-50%);background:radial-gradient(circle,rgba(130,150,255,.1),transparent 65%);pointer-events:none;z-index:-1}
.hero-title{font-size:clamp(40px,7vw,76px);font-weight:800;letter-spacing:-.045em;line-height:1.02;color:#fff;max-width:820px;margin-bottom:20px;animation:blurIn 1.2s ease .1s both}
.hero-tag{font-size:clamp(15px,2vw,19px);font-weight:500;color:#999;letter-spacing:-.01em;max-width:460px;line-height:1.6;animation:blurIn 1.2s ease .2s both}
.hero-cta{margin-top:32px;animation:blurIn 1.2s ease .3s both}
.home-cursor{display:inline-block;width:2px;height:1em;background:#fff;margin-left:2px;animation:blink .6s step-end infinite;vertical-align:text-bottom}
.editable-home{cursor:text;transition:background .3s;border-radius:4px;padding:2px 6px;margin:-2px -6px;min-height:1.6em}
.editable-home:hover{background:rgba(255,255,255,.06)}
.editable-home:focus{outline:none;cursor:none}
.editable-home:focus .home-cursor{display:none}
.hover-swap{transition:filter .25s ease,opacity .25s ease}
.reveal{opacity:0;transform:translateY(24px);transition:opacity .8s ease,transform .8s cubic-bezier(.25,.6,.35,1)}
.reveal.in{opacity:1;transform:none}
.reveal[data-d="1"]{transition-delay:.08s}
.reveal[data-d="2"]{transition-delay:.16s}
.reveal[data-d="3"]{transition-delay:.24s}
@keyframes blurIn{0%{filter:blur(20px);opacity:0}100%{filter:blur(0);opacity:1}}
@keyframes crtFlicker{0%,100%{opacity:1}5%{opacity:.8}10%{opacity:1}15%{opacity:.6}20%{opacity:1}50%{opacity:.95}55%{opacity:1}}
...
.cloud-wall{position:absolute;top:-14%;bottom:-14%;width:80%;transition:transform var(--slideDur,1.2s) cubic-bezier(0.42,0,1,1);will-change:transform}
...
.ci-2{width:180%;top:21%;left:-10%}
.ci-3{width:180%;top:52%;left:-25%}
.ci-4{width:225%;top:-25%;right:-30%}
.ci-5{width:180%;top:21%;right:-10%}
.ci-6{width:180%;top:52%;right:-25%}
.ci-7{width:175%;top:38%;left:-15%}
.ci-8{width:175%;top:38%;right:-15%}
.ci-9,.ci-10{display:none}
@media (max-aspect-ratio:1/1){.cloud-wall{width:100%}.cloud-wall-left{left:-14%}.cloud-wall-right{right:-14%}.ci-1{width:265%;top:-22%;left:-50%}.ci-4{width:265%;top:-22%;right:-50%}.ci-7{width:235%;top:4%;left:8%}.ci-8{width:235%;top:4%;right:8%}.ci-2{width:240%;top:26%;left:-40%}.ci-5{width:240%;top:26%;right:-40%}.ci-3{width:240%;top:50%;left:2%}.ci-6{width:240%;top:50%;right:2%}.ci-9{display:block;width:170%;bottom:0;left:-10%}.ci-10{display:block;width:170%;bottom:0;right:-10%}.cloud-wall-left{transform:translateX(-235%)}.cloud-wall-right{transform:translateX(235%)}.page-load-overlay.clear .cloud-wall-left{transform:translateX(-235%)}.page-load-overlay.clear .cloud-wall-right{transform:translateX(235%)}}
.page-load-overlay{position:fixed;top:0;left:0;right:0;bottom:0;z-index:10001;pointer-events:none;opacity:1;visibility:visible;transition:opacity .7s ease .2s,visibility 0s 1.1s;overflow:hidden;background:#0A0A0A}
.page-load-overlay.clear{opacity:0;visibility:hidden}
.page-load-overlay .cloud-wall-left,.page-load-overlay .cloud-wall-right{transform:translateX(0);transition:transform var(--slideDur,1.2s) cubic-bezier(0.42,0,1,1)}
.page-load-overlay.clear .cloud-wall-left{transform:translateX(-190%)}
.page-load-overlay.clear .cloud-wall-right{transform:translateX(190%)}"""


def make_banner(active=""):
    def nav_a(href, text):
...
{links}
      <a class="banner-ig" href="https://instagram.com/aurionzen" target="_blank" rel="noopener">
...
PAGELOAD = """<div class="page-load-overlay" id="pageLoad">
  <div class="cloud-wall cloud-wall-left">
    <img class="cloud-img ci-1" data-cloud alt="" draggable="false" width="1200" height="532" fetchpriority="high">
    <img class="cloud-img ci-2" data-cloud alt="" draggable="false" width="1200" height="532" fetchpriority="high">
    <img class="cloud-img ci-7" data-cloud alt="" draggable="false" width="1200" height="532" fetchpriority="high">
    <img class="cloud-img ci-3" data-cloud alt="" draggable="false" width="1200" height="532" fetchpriority="high">
    <img class="cloud-img ci-9" data-cloud alt="" draggable="false" width="1200" height="532" fetchpriority="high">
  </div>
  <div class="cloud-wall cloud-wall-right">
    <img class="cloud-img ci-4" data-cloud alt="" draggable="false" width="1200" height="532" fetchpriority="high">
    <img class="cloud-img ci-5" data-cloud alt="" draggable="false" width="1200" height="532" fetchpriority="high">
    <img class="cloud-img ci-8" data-cloud alt="" draggable="false" width="1200" height="532" fetchpriority="high">
    <img class="cloud-img ci-6" data-cloud alt="" draggable="false" width="1200" height="532" fetchpriority="high">
    <img class="cloud-img ci-10" data-cloud alt="" draggable="false" width="1200" height="532" fetchpriority="high">
  </div>
</div>"""
...
SITE_VERSION = "-1"
SITE_URL = "https://aurion-9530d2d6.vercel.app"
META_DESC = "Aurion — independent studio building focused digital tools."

FOOTER = f"""<footer>
    <div class="footer-inner">
      <div class="footer-left">
        <span>&copy; 2026 Aurion</span>
      </div>
...
SCRIPT = """<script>
  ...
  function initNavInd() {
    ...
    if (!nav || nav.dataset.indInit) { syncNavInd(); return; }
    nav.dataset.indInit = '1';
    navLinks().forEach(a => {
      a.addEventListener('mouseenter', () => moveNavInd(a));
    });
    nav.querySelectorAll('.banner-ig').forEach(b => {
      b.addEventListener('mouseenter', () => moveNavInd(null));
      b.addEventListener('mouseleave', syncNavInd);
    });
    nav.addEventListener('mouseleave', syncNavInd);
    syncNavInd();
  }
  function syncNavInd() {
    const links = navLinks();
    moveNavInd(links.find(a => a.classList.contains('active')) || null);
  }
  function initSpot() {
    document.querySelectorAll('.banner-ig').forEach(b => {
      b.onmousemove = (e) => {
  ...
  function initReveal() {
    ...
    _revObs = new IntersectionObserver((entries) => {
      entries.forEach(en => { if (en.isIntersecting) { en.target.classList.add('in'); _revObs.unobserve(en.target); } });
    }, { threshold: 0.12, rootMargin: '0px 0px -8% 0px' });
    els.forEach(el => _revObs.observe(el));
  }
  ...
  function initFooterReveal() {
    ...
    function onWheel(e) {
      ...
      if (e.deltaY > 0 && atBottom) footer.classList.add('visible');
      else if (e.deltaY < 0) footer.classList.remove('visible');
    }
    window.removeEventListener('wheel', window._footerWheel);
    window._footerWheel = onWheel;
    window.addEventListener('wheel', onWheel, { passive: true });
  }
  function scatterClouds() {
    if (window._cloudScatter) return;
    window._cloudScatter = true;
    const rnd = (a, b) => a + Math.random() * (b - a);
    const narrow = matchMedia('(max-aspect-ratio: 1/1)').matches;
    document.querySelectorAll('.cloud-img').forEach(img => {
      if (!narrow && (img.classList.contains('ci-9') || img.classList.contains('ci-10'))) return;
  ...
  function cloudTravel() {
    return matchMedia('(max-aspect-ratio: 1/1)').matches ? 235 : 152;
  }
  function cloudDuration() {
    return Math.min(2000, Math.max(900, Math.round(cloudTravel() / 130 * 1000)));
  }
  function fadeDuration() {
    const ar = window.innerWidth / Math.max(1, window.innerHeight);
    return Math.min(1200, Math.max(700, Math.round(450 * ar)));
  }
  function updateTiming() {
    document.documentElement.style.setProperty('--slideDur', cloudDuration() + 'ms');
    document.documentElement.style.setProperty('--fadeDur', fadeDuration() + 'ms');
    syncNavInd();
  }
  window.addEventListener('resize', updateTiming);
  if (document.fonts && document.fonts.ready) document.fonts.ready.then(() => syncNavInd());
  // note: no mousemove blur — empty edit screen persists until mouseleave / click-outside
  function initHomeEditable() {
    const el = document.querySelector('.editable-home');
    if (!el || el.dataset.homeInit) return;
    el.dataset.homeInit = '1';
    const def = el.dataset.default;
    const hover = el.dataset.hover;
    let swapTimer = null;
    let typed = null;
    let refocusSpent = false;
    function cancelSwap() { if (swapTimer) { clearTimeout(swapTimer); swapTimer = null; } el.style.filter = ''; }
    function animateTo(text) {
      if (el.textContent === text && !swapTimer) { cancelSwap(); return; }
      cancelSwap();
      el.style.transition = 'filter .2s ease';
      el.style.filter = 'blur(8px)';
      swapTimer = setTimeout(() => { el.textContent = text; el.style.filter = 'blur(0)'; swapTimer = null; }, 200);
    }
    let leaveTimer = null;
    ...
    el.addEventListener('mouseenter', () => {
      ...
      cancelSwap();
      animateTo(typed !== null ? typed : hover);
    });
    ...
    el.addEventListener('focus', () => {
      ...
      if (cur === def || cur === hover) el.textContent = '';
    });

    el.addEventListener('input', () => { refocusSpent = true; const v = el.textContent.trim(); typed = v || null; });
    el.addEventListener('blur', () => {
      cancelSwap();
      const v = el.textContent.trim();
      if (!v || v === def) {
        if (el.matches(':hover')) {
          if (!v && !refocusSpent) { refocusSpent = true; el.focus({ preventScroll: true }); }
          return;
        }
        typed = null; animateTo(def);
      }
    });
    el.addEventListener('keydown', (e) => {
      if (e.key === 'Tab') refocusSpent = true;
      if (e.key === 'Enter') {
        e.preventDefault();
        if (el.textContent.trim() === 'Why?') {
          el.blur();
          if (typeof pjaxGo === 'function') pjaxGo('/en/easter', true);
          else window.location.href = '/en/easter';
        }
      }
    });
  }
  window.addEventListener('scroll', () => { if (!ticking) { requestAnimationFrame(updateBanner); ticking = true; } }, { passive: true });
  window.addEventListener('resize', () => { if (!ticking) { requestAnimationFrame(updateBanner); ticking = true; } }, { passive: true });
  updateBanner();

  const overlay = document.getElementById('transOverlay');
  const cloud = document.getElementById('transCloud');
  const pageLoad = document.getElementById('pageLoad');

  function clearPageLoad() { if (pageLoad && !pageLoad.classList.contains('clear')) pageLoad.classList.add('clear'); }
  function coverOn() { overlay.classList.add('active'); cloud.classList.add('active'); }
  function coverOff() { cloud.classList.remove('active'); overlay.classList.remove('active'); }
   ...
   function cloudReady() {
     ...
     _cloudSrcNow = want;
     document.querySelectorAll('img[data-cloud]').forEach((im) => {
       if (im.getAttribute('src') !== want) { im.setAttribute('src', want); dirty = true; }
     });
     if (!dirty && _cloudP) return _cloudP;
     const tc = document.getElementById('transCloud'), pl = document.getElementById('pageLoad');
     if (tc) tc.classList.remove('ready');
     if (pl) pl.classList.remove('ready');
     _cloudP = new Promise((res) => {
       const imgs = Array.from(document.querySelectorAll('img[data-cloud]'));
       let n = imgs.length;
       if (!n) { res(); return; }
       const done = () => {
         if (--n <= 0) {
           if (tc) tc.classList.add('ready');
           if (pl) pl.classList.add('ready');
           res();
         }
       };
       imgs.forEach((im) => {
         const fin = () => { if (im.decode) { im.decode().then(done).catch(done); } else done(); };
         if (im.complete && im.naturalWidth > 0) fin();
         else { im.onload = fin; im.onerror = done; }
       });
     });
     return _cloudP;
   }
  ...
  initPage();
   ...
   async function pjaxGo(href, push) {
    ...
    const fresh = doc.getElementById('site');
    if (!fresh) { window.location.href = href; return; }
    document.getElementById('site').innerHTML = fresh.innerHTML;
    const t = doc.querySelector('title');
    if (t) document.title = t.textContent;
    if (push) history.pushState({ pjax: 1 }, '', href);
    window.scrollTo(0, 0);
    initPage();
  ...
  window.addEventListener('popstate', () => { pjaxGo(location.pathname, false); });
</script>"""
...
def make_page(title, label, desc, is_home=False, active="", slug="index.html"):
  ...
  <meta property="og:url" content="{SITE_URL}/en/{slug}">
  <meta property="og:image" content="{SITE_URL}/en/og-image.png">
...
<head>
  ...
  <link rel="preload" as="image" media="(max-aspect-ratio: 11/10)" href="/en/cloud-low.webp" fetchpriority="high">
  <link rel="preload" as="image" media="(min-aspect-ratio: 11/10)" href="/en/cloud-main.webp" fetchpriority="high">
...
banner.classList.toggle('dark', brightness &lt; 128);</pre>
    ...
    <p style="text-align:center;color:#666;font-size:13px">End of test — scroll back up.</p>
        ...
        content = """
  <div class="page">
    <h1 class="page-title reveal">...</h1>
  </div>"""
    elif desc:
        content = f"""
  <div class="page">
    <h1 class="page-title reveal">{title}</h1>
    <p class="page-desc reveal">{desc}</p>
  </div>"""
    else:
        content = f"""
  <div class="page">
...
<head>
  ...
  <meta property="og:type" content="website">
  <meta property="og:site_name" content="Aurion">
  <meta property="og:title" content="404 - Aurion">
  <meta property="og:description" content="Page not found — Aurion.">
  <meta property="og:url" content="https://aurion-9530d2d6.vercel.app/en/404.html">
  <meta property="og:image" content="https://aurion-9530d2d6.vercel.app/en/og-image.png">
  <meta name="twitter:card" content="summary">
  <meta name="twitter:site" content="@aurionzen">
  <meta name="theme-color" content="#0A0A0A">
  <meta name="color-scheme" content="dark">
...
# Root-level copy for Vercel's 404.html convention (served on any unmatched route)
with open(os.path.join(os.path.dirname(BASE), "404.html"), "w") as f:
    f.write(not_found)
print("Created root 404.html (Vercel)")

# SEO companions (served at /robots.txt and /sitemap.xml)
ROOT_DIR = os.path.dirname(BASE)
with open(os.path.join(ROOT_DIR, "robots.txt"), "w") as f:
