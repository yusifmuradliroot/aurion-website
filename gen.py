...
.banner-nav{display:flex;gap:24px;align-items:center}
...
.banner-nav a:not(.banner-ig)::after{content:"";position:absolute;left:0;bottom:-5px;height:1px;width:100%;background:#fff;transform:scaleX(0);transform-origin:right;transition:transform .35s cubic-bezier(.25,.6,.35,1)}
.banner-nav a:not(.banner-ig):hover::after,.banner-nav a.active::after{transform:scaleX(1);transform-origin:left}
...
.banner-ig{display:inline-flex;align-items:center;align-self:center;gap:6px;padding:6px 14px;border-radius:980px;background:linear-gradient(135deg,rgba(255,255,255,.16),rgba(255,255,255,.06));-webkit-backdrop-filter:blur(12px) saturate(1.4);backdrop-filter:blur(12px) saturate(1.4);color:#fff;text-decoration:none;font-size:12px;font-weight:500;transition:all .3s;border:1px solid rgba(255,255,255,.2);box-shadow:inset 0 1px 1px rgba(255,255,255,.28),0 4px 16px rgba(0,0,0,.3);line-height:1;position:relative;overflow:hidden}
.banner-ig::before{content:"";position:absolute;inset:0;border-radius:inherit;background:rgba(255,255,255,.16);transform:scaleX(0);transform-origin:left;transition:transform .35s cubic-bezier(.25,.6,.35,1)}
.banner-ig:hover::before{transform:scaleX(1)}
.banner-ig:hover{background:linear-gradient(135deg,rgba(255,255,255,.26),rgba(255,255,255,.12));box-shadow:inset 0 1px 1px rgba(255,255,255,.35),0 6px 20px rgba(0,0,0,.4)}
...
.top-banner.dark .banner-ig{background:linear-gradient(135deg,rgba(255,255,255,.16),rgba(255,255,255,.06));color:#fff;border-color:rgba(255,255,255,.2);box-shadow:inset 0 1px 1px rgba(255,255,255,.28),0 4px 16px rgba(0,0,0,.3)}
...
SCRIPT = """<script>
  ...
  function initPage() { updateBanner(); initHome(); initHomeEditable(); updateTiming(); scatterClouds(); initFooterReveal(); initMobileMenu(); initReveal(); }
  let _revObs = null;
  function initReveal() {
...
def make_page(title, label, desc, is_home=False, active="", slug="index.html"):
  ...
  <meta property="og:title" content="{title} - Aurion">
  ...
  <meta name="twitter:title" content="{title} - Aurion">
